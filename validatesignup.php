    ...
    <div class="container_signup">
        <form action="addcustomer.php" method="post" onsubmit="return validate(this);">
            ...
            <div class="form-group">
                ...
                <input type="text" name="address_1" size="50">
            </div>
            
            <div class="form-group">
                <label>Full Name:</label>
                <input type="text" name="complete_name" size="50" class="firstinput">
            </div>
            ...
            <div class="form-group">
                <label>Email:</label>
                <input type="text" name="emailaddress" size="30" class="firstinput">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" size="30" class="firstinput">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" name="repassword" size="30" class="firstinput">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="phone_no" size="20" class="firstinput">
            </div>
